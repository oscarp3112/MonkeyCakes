				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="administrador.php"> Administrar contraseñas</a></p>
				...
				<div class="container">
					...
					<table class="table table-bordered">
             		...
             		<tr>
             			...
             			<td>
             				<input name="<?php echo 'tb'.$filas['IDcliente'];?>" placeholder="Nueva constraseña"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nueva contraseña'"   type="text">
             			</td>
             			<td>
             				<input name="<?php echo 'check'.$filas['IDcliente'];?>" placeholder="Activo"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Activo'"
             				<?php 
                            ...
                            if (isset($_POST['Realizar']) ) {
				           	...
				           	while ($filas = mysqli_fetch_assoc($resultado))
     				         {
                                ...
                                //Busqueda de nombre de textbox
     				         	$cadenaName = "tb".$filas['IDcliente'];
     				         	$cadenaName2 = "check".$filas['IDcliente'];
     				         	//Nueva password
     				         	$passnueva = $_POST[$cadenaName];

     				         	if (isset($_POST[$cadenaName2])) {
     				         	$CadenaUpdate = "update clientes set Estado = 'activo' WHERE IDcliente =".$filas['IDcliente'].";";
     				            $DefEstado = $mysqli ->query($CadenaUpdate);

     				         	}
     				         	else
     				         	{
     				         	$CadenaUpdate = "update clientes set Estado = 'inactivo' WHERE IDcliente =".$filas['IDcliente'].";";
     				            $DefEstado = $mysqli ->query($CadenaUpdate);
     				         	}
     				         	...
     				         	if($passnueva != "")
     				         	{
     				         		...
     				         		$CadenaUpdate = "update clientes set Password = '".$passnueva."' WHERE IDcliente =".$filas['IDcliente'].";";
     				                $guardarPass = $mysqli ->query($CadenaUpdate);
